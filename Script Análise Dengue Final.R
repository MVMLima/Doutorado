...
set.seed(123)
x <- ts(dengue$MT[-(1:12)], start = c(2001,1), frequency = 12)
x = log(x)
test_x <- window(x, start=c(2017,1))
x <- window(x, end=c(2016,12))
...
x <- ts(dengue$MT[-(1:12)], start = c(2001,1), frequency = 12)
x = log(x)
test_x <- window(x, start=c(2017,7))
x <- window(x, end=c(2017,6))
...
x <- ts(dengue$MT[-(1:12)], start = c(2001,1), frequency = 12)
x = log(x)
test_x <- window(x, start=c(2017,10))
x <- window(x, end=c(2017,9))
